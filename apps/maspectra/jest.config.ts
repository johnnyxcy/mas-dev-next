/*
 * File: @mas/maspectra/jest.config.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 09/08/2023 10:20 am
 *
 * Last Modified: 09/08/2023 10:23 am
 *
...
const config: JestConfigWithTsJest = {
    ...
    // moduleNameMapper: {
    //     "^@mas/maspectra/(.*)$": "<rootDir>/src/$1",
    //     "^@mas/noctowl/(.*)$": "<rootDir>/../../libs/noctowl/src/$1",
    // },
