/*
 * File: @mas/i18n/src/node/localization-provider.ts
 *
...
export class LocalizationProvider {
    ...
    addLocalizations(...localizations: ILocalization[]): void {
        this.localizations.push(...localizations);
    }

    removeLocalizations(...localizations: ILocalization[]): void {
    ...
    getAvailableLanguages(all?: boolean): ILanguageInfo[] {
        const languageInfos = new Map<string, ILanguageInfo>();
    ...
    loadLocalization(languageId: string): ILocalization {
        const merged: ILocalization = {
            languageId,
            translations: {},
        };
