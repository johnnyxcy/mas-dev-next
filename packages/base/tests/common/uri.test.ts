/*
 * File: @mas/base/tests/common/uri.test.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 09/27/2023 11:34 am
 *
 * Last Modified: 09/27/2023 11:37 am
 *
...
import { URI, UriComponents, isUriComponents } from "@mas/base/common/uri";
...
describe("URI", () => {
    ...
    test("correctFileUriToFilePath2", () => {
        const doAssert = (input: string, expected: string) => {
        ...
        doAssert("file:///c:/alex.txt", isWindows ? "c:\\alex.txt" : "c:/alex.txt");
        doAssert(
    ...
    test.skipIf(isWindows)("URI#joinPath (posix)", () => {
    ...
    test.skipIf(!isWindows)("URI#joinPath (windows)", () => {
