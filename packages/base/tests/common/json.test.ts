/*
 * File: @mas/base/tests/common/json.test.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 09/26/2023 04:44 pm
 *
 * Last Modified: 09/26/2023 05:10 pm
 *
...
import {
    ...
    ScanError,
    SyntaxKind,
} from "@mas/base/common/json";
import { getParseErrorMessage } from "@mas/base/common/json-error-message";
