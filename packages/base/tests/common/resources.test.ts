/*
 * File: @mas/base/tests/common/resources.test.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 09/27/2023 04:02 pm
 *
...
import { toSlashes } from "@mas/base/common/extpath";
import { posix, win32 } from "@mas/base/common/path";
...
describe("Resources", () => {
    ...
    function assertResolve(u1: URI, path: string, expected: URI) {
        ...
        const p = path.includes("/") ? posix : win32;
