/*
 * File: @mas/base/tests/common/arrays.test.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 09/27/2023 01:12 pm
 *
...
import * as arraysFind from "@mas/base/common/arrays-find";
