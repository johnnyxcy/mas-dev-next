/*
 * File: @mas/base/tests/common/linked-text.test.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 09/27/2023 05:07 pm
 *
 * Last Modified: 09/27/2023 05:08 pm
 *
...
import { parseLinkedText } from "@mas/base/common/linked-text";
...
describe("LinkedText", () => {
    ...
    test("Should match non-greedily", () => {
        assert.deepStrictEqual(
            parseLinkedText('a [link text 1](http://link.href "title1") b [link text 2](http://link.href "title2") c')
                .nodes,
            [
                "a ",
