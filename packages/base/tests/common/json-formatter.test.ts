/*
 * File: @mas/base/tests/common/json-formatter.test.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 09/26/2023 04:44 pm
 *
 * Last Modified: 09/26/2023 05:09 pm
 *
...
import * as Formatter from "@mas/base/common/json-formatter";

describe("JSON - formatter", () => {
    function format(content: string, expected: string, insertSpaces = true) {
        let range: Formatter.Range | undefined;
