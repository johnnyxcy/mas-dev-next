/*
 * File: @mas/base/tests/common/color.test.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 09/27/2023 05:38 pm
 *
 * Last Modified: 09/27/2023 05:39 pm
 *
...
import { Color, HSLA, HSVA, RGBA } from "@mas/base/common/color";
