/*
 * File: @mas/base/tests/common/fuzzy-scorer.test.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 09/27/2023 06:17 pm
 *
 * Last Modified: 09/27/2023 06:19 pm
 *
...
import {
    ...
    scoreFuzzy2,
    scoreItemFuzzy,
} from "@mas/base/common/fuzzy-scorer";
import { Schemas } from "@mas/base/common/network";
import { basename, dirname, posix, sep, win32 } from "@mas/base/common/path";
...
describe("Fuzzy Scorer", () => {
    ...
    test("fuzzyScore2 (multiple queries)", function () {
        ...
        function assertScore() {
            assert.ok(multiScore ?? (firstSingleScore ?? 0) + (secondSingleScore ?? 0) <= 0);
