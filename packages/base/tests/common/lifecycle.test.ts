/*
 * File: @mas/base/tests/common/lifecycle.test.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 09/27/2023 02:21 pm
 *
 * Last Modified: 09/27/2023 02:29 pm
 *
...
import { ensureNoDisposablesAreLeakedInTestSuite, throwIfDisposablesAreLeaked } from "@mas/base/testing/common/utils";
...
function assertThrows(fn: () => void, testFn: (error: any) => void) {
    try {
        fn();
    ...
    describe("throwIfDisposablesAreLeaked", () => {
        test("throws if an event subscription is not cleaned up", () => {
            ...
            assertThrows(
                ...
                (e) => e.message.includes("undisposed disposables"),
            );
        });
