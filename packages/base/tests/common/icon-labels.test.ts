/*
 * File: @mas/base/tests/common/icon-labels.test.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 11/02/2023 02:47 pm
 *
 * Last Modified: 11/02/2023 02:48 pm
 *
...
import { IMatch } from "@mas/base/common/filters";
import {
    ...
    parseLabelWithIcons,
    stripIcons,
} from "@mas/base/common/icon-labels";
