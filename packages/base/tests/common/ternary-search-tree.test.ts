/*
 * File: @mas/base/tests/common/ternary-search-tree.test.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 09/27/2023 04:12 pm
 *
 * Last Modified: 09/27/2023 06:07 pm
 *
...
import { shuffle } from "@mas/base/common/arrays";
...
import {
    ...
    TernarySearchTree,
    UriIterator,
} from "@mas/base/common/ternary-search-tree";
...
describe.skipIf(!process.env.TEST_PERF)("TST, perf", function () {
     ...
     *
     * NOTE: dont change the function name since vitest vscode extension
     * uses ast parser to run the test, only `it` and `test` will work
     *
     * https://github.com/vitest-dev/vscode/issues/133
     */
    function it(name: string, callback: Function) {
        test(name, function () {
            if (_profile) {
    ...
    it("TST, clear", function () {
        tree.clear();
    });

    it("TST, insert", function () {
