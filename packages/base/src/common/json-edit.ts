/*
 * File: @mas/base/src/common/json-edit.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 09/26/2023 05:15 pm
 *
 ...
 */
import { findNodeAtLocation, JSONPath, Node, ParseError, parseTree, Segment } from "@mas/base/common/json";
import { Edit, format, FormattingOptions, isEOL } from "@mas/base/common/json-formatter";
    ...
    if (!parent) {
        ...
        if (value !== undefined) {
            ...
            if (parent.children.length === 0 || lastSegment === 0) {
                ...
                const index =
                    lastSegment === -1 || lastSegment > parent.children.length ? parent.children.length : lastSegment;
                const previous = parent.children[index - 1];
                edit = { offset: previous.offset + previous.length, length: 0, content: "," + newProperty };
            }
            return withFormatting(text, edit, formattingOptions);
