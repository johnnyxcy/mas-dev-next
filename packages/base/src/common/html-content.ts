...
import { escapeIcons } from "@mas/base/common/icon-labels";
import { isEqual } from "@mas/base/common/resources";
import { escapeRegExpCharacters } from "@mas/base/common/strings";
...
export function parseHrefAndDimensions(href: string): { href: string; dimensions: string[] } {
    ...
    if (parameters) {
        ...
        const widthIsFinite = Number.isFinite(Number.parseInt(width));
        const heightIsFinite = Number.isFinite(Number.parseInt(height));
        if (widthIsFinite) {
