/*
 * File: @mas/base/src/common/glob.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 09/27/2023 06:21 pm
 *
 * Last Modified: 09/27/2023 06:22 pm
 *
...
import { equals } from "@mas/base/common/arrays";
import { isThenable } from "@mas/base/common/async";
import { CharCode } from "@mas/base/common/char-code";
import { isEqualOrParent } from "@mas/base/common/extpath";
import { LRUCache } from "@mas/base/common/map";
import { basename, extname, posix, sep } from "@mas/base/common/path";
import { isLinux } from "@mas/base/common/platform";
import { escapeRegExpCharacters, ltrim } from "@mas/base/common/strings";
...
function starsToRegExp(starCount: number, isLastPattern?: boolean): string {
    switch (starCount) {
        ...
        default:
            ...
            return `(?:${PATH_REGEX}|${NO_PATH_REGEX}+${PATH_REGEX}${
                isLastPattern ? `|${PATH_REGEX}${NO_PATH_REGEX}+` : ""
            })*?`;
    }
}
