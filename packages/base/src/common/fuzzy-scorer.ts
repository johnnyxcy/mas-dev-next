/*
 * File: @mas/base/src/common/fuzzy-scorer.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 09/27/2023 06:16 pm
 *
 * Last Modified: 09/27/2023 06:17 pm
 *
...
import { compareAnything } from "@mas/base/common/comparers";
import {
...
import { equalsIgnoreCase, stripWildcards } from "@mas/base/common/strings";
...
export function prepareQuery(original: string): IPreparedQuery {
    ...
    const containsPathSeparator = pathNormalized.includes(sep);
