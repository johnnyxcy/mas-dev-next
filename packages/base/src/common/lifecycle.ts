/*
 * File: @mas/base/src/common/lifecycle.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 09/27/2023 01:37 pm
 *
 * Last Modified: 09/27/2023 01:38 pm
 *
...
import { compareBy, numberComparator } from "@mas/base/common/arrays";
import { groupBy } from "@mas/base/common/collections";
import { createSingleCallFunction } from "@mas/base/common/functional";
import { Iterable } from "@mas/base/common/iterator";
import { SetMap } from "@mas/base/common/map";
...
export class DisposableTracker implements IDisposableTracker {
    ...
    computeLeakingDisposables(
        ...
        for (const leaking of uncoveredLeakingObjs.slice(0, maxReported)) {
            ...
            message += `\n\n\n==================== Leaking disposable ${i}/${uncoveredLeakingObjs.length}: ${
                leaking.value.constructor.name
