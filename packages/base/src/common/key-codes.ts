/*
 * File: @mas/base/src/common/key-codes.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 09/27/2023 05:09 pm
 *
 * Last Modified: 09/27/2023 05:09 pm
 *
...
class KeyCodeStrMap {
    _keyCodeToStr: string[];
    _strToKeyCode: { [str: string]: KeyCode };
