/*
 * File: @mas/base/src/common/platform.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 09/26/2023 05:31 pm
 *
 * Last Modified: 09/26/2023 05:40 pm
 *
...
if (typeof navigator === "object" && !isElectronRenderer) {
    ...
    _isIOS =
        (_userAgent.includes("Macintosh") || _userAgent.includes("iPad") || _userAgent.includes("iPhone")) &&
    ...
    const configuredLocale = nls.locale;
