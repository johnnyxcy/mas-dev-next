/*
 * File: @mas/base/src/common/strings.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 09/27/2023 03:35 pm
 *
 * Last Modified: 10/17/2023 05:03 pm
 *
...
import { LRUCachedFunction } from "@mas/base/common/cache";
import { CharCode } from "@mas/base/common/char-code";
import { Lazy } from "@mas/base/common/lazy";
import { Constants } from "@mas/base/common/uint";
...
class GraphemeBreakTree {
    ...
    static getInstance(): GraphemeBreakTree {
    ...
    getGraphemeBreakType(codePoint: number): GraphemeBreakType {
...
export class AmbiguousCharacters {
    ...
    private static readonly cache = new LRUCachedFunction<string[], AmbiguousCharacters>((locales) => {
