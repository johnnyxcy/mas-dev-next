/*
 * File: @mas/base/src/common/search.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 09/28/2023 09:05 am
 *
 * Last Modified: 09/28/2023 09:06 am
 *
...
function validateSpecificSpecialCharacter(matches: string[], pattern: string, specialCharacter: string): boolean {
    const doesContainSpecialCharacter = matches[0].includes(specialCharacter) && pattern.includes(specialCharacter);
    return (
