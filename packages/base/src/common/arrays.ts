/*
 * File: @mas/base/src/common/arrays.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 09/27/2023 01:10 pm
 *
 * Last Modified: 09/27/2023 02:14 pm
 *
...
import { findFirstIdxMonotonousOrArrLen } from "@mas/base/common/arrays-find";
import { type CancellationToken } from "@mas/base/common/cancellation";
import { CancellationError } from "@mas/base/common/errors";
import { type ISplice } from "@mas/base/common/sequence";
...
export class CallbackIterable<T> {
    static readonly empty = new CallbackIterable<never>((_callback) => {});
