/*
 * File: @mas/base/src/common/themables.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 09/25/2023 06:03 pm
 *
 * Last Modified: 09/25/2023 06:05 pm
 *
...
import { Codicon } from "@mas/base/common/codicons";
...
export function themeColorFromId(id: ColorIdentifier): ThemeColor {
    return { id };
}
