/*
 * File: @mas/base/src/browser/keyboard-event.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 10/12/2023 01:43 pm
 *
 * Last Modified: 10/12/2023 01:43 pm
 *
...
import { EVENT_KEY_CODE_MAP, KeyCode, KeyCodeUtils, KeyMod } from "@mas/base/common/key-codes";
import { KeyCodeChord } from "@mas/base/common/keybindings";
...
export function printStandardKeyboardEvent(e: StandardKeyboardEvent): string {
    ...
    return `modifiers: [${modifiers.join(",")}], code: ${e.code}, keyCode: ${e.keyCode} ('${KeyCodeUtils.toString(
        e.keyCode,
    )}')`;
}
