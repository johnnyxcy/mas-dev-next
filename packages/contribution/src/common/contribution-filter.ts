/*
 * File: @mas/contribution/src/common/contribution-filter.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 09/25/2023 11:01 pm
 *
...
export const IContributionFilterRegistry = Symbol("IContributionFilterRegistry");
export interface IContributionFilterRegistry {
    /**
...
export const IFilterContribution = Symbol("IFilterContribution");
/**
 * Register filters to remove contributions.
 */
export interface IFilterContribution {
    /**
     * Use the registry to register your contribution filters.
     */
    registerContributionFilters(registry: IContributionFilterRegistry): void;
}
