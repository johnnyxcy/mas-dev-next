/*
 * File: @mas/core/tests/parts/storage/node/storage.test.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 10/25/2023 02:35 pm
 *
 * Last Modified: 10/25/2023 02:41 pm
 *
...
} from "@mas/core/parts/storage/common/storage";
import { ISQLiteStorageDatabaseOptions, SQLiteStorageDatabase } from "@mas/core/parts/storage/node/storage";

const { strictEqual, ok, deepStrictEqual } = assert;
    ...
    function () {
        ...
        test("basics", () => {
            return runWithFakedTimers({}, async function () {
                ...
                await Promise.all([set1Promise, set2Promise, set3Promise, set4Promise]).then(
                ...
                await Promise.all([delete1Promise, delete2Promise, delete3Promise, delete4Promise]).then(
        ...
        test("external changes", () => {
            return runWithFakedTimers({}, async function () {
                class TestSQLiteStorageDatabase extends SQLiteStorageDatabase {
                    ...
                    override get onDidChangeItemsExternal(): Event<IStorageItemsChangeEvent> {
