// /*
//  * File: @mas/core/tests/workbench/commands/common/command-service.test.ts
//  *
//  * Author: Johnny Xu <johnny.xcy1997@outlook.com>
//  *
//  * File Created: 10/18/2023 01:19 pm
//  *
//  * Last Modified: 10/18/2023 02:03 pm
//  *
...
//         const whenInstalledExtensionsRegistered = new Promise<boolean>((_resolve) => {
...
//             assert.deepStrictEqual(actualOrder, ["before call", "executing command", "after call", "resolved"]);
//         } finally {
//             disposables.dispose();
//         }
//     });
