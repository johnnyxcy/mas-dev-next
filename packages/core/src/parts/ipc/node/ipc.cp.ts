/*
 * File: @mas/core/src/parts/ipc/node/ipc.cp.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 10/18/2023 03:23 pm
 *
 * Last Modified: 10/24/2023 10:09 am
 *
...
import { createCancelablePromise, Delayer } from "@mas/base/common/async";
import { BinaryBuffer } from "@mas/base/common/buffer";
import { CancellationToken } from "@mas/base/common/cancellation";
import { isRemoteConsoleLog, log } from "@mas/base/common/console";
import * as errors from "@mas/base/common/errors";
import { Emitter, Event } from "@mas/base/common/event";
import { dispose, IDisposable, toDisposable } from "@mas/base/common/lifecycle";
import { deepClone } from "@mas/base/common/objects";
import { removeDangerousEnvVariables } from "@mas/base/common/processes";
import { createQueuedSender } from "@mas/base/node/processes";
import {
    IChannel,
    IChannelClient,
        ...
        super(
            {
                ...
                onMessage: Event.fromNodeEventEmitter(process, "message", (msg) =>
                    BinaryBuffer.wrap(Buffer.from(msg, "base64")),
                ),
            },
            ctx,
        );
...
export class Client implements IChannelClient, IDisposable {
    ...
    private get client(): IPCClient {
        if (!this._client) {
            ...
            const onMessageEmitter = new Emitter<BinaryBuffer>();
            ...
            onRawMessage((msg) => {
                ...
                onMessageEmitter.fire(BinaryBuffer.wrap(Buffer.from(msg, "base64")));
            });

            const sender = this.options.useQueue ? createQueuedSender(this.child) : this.child;
            const send = (r: BinaryBuffer) =>
