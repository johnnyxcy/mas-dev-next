/*
 * File: @mas/core/src/platform/files/common/disk-file-system-provider.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 11/02/2023 03:11 pm
 *
 * Last Modified: 11/02/2023 03:12 pm
 *
...
import { insert } from "@mas/base/common/arrays";
import { ThrottledDelayer } from "@mas/base/common/async";
import { onUnexpectedError } from "@mas/base/common/errors";
import { Emitter } from "@mas/base/common/event";
import { Disposable, IDisposable, toDisposable } from "@mas/base/common/lifecycle";
import { normalize } from "@mas/base/common/path";
import { URI } from "@mas/base/common/uri";
import { IFileChange, IFileSystemProvider, IWatchOptions } from "@mas/core/platform/files/common/files";
import {
...
import { ILogService, LogLevel } from "@mas/core/platform/log/common/log";
        ...
        Pick<IFileSystemProvider, "onDidWatchError">
{
    ...
    private watchUniversal(resource: URI, opts: IWatchOptions): IDisposable {
        ...
        const pathToWatch: IUniversalWatchRequest = {
    ...
    private watchNonRecursive(resource: URI, opts: IWatchOptions): IDisposable {
        ...
        const pathToWatch: INonRecursiveWatchRequest = {
            path: this.toFilePath(resource),
            excludes: opts.excludes,
            includes: opts.includes,
            recursive: false,
