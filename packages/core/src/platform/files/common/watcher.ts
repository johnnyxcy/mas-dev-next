/*
 * File: @mas/core/src/platform/files/common/watcher.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 11/02/2023 03:03 pm
 *
 * Last Modified: 11/02/2023 03:04 pm
 *
...
import { GLOBSTAR, IRelativePattern, parse, ParsedPattern } from "@mas/base/common/glob";
import { Disposable, DisposableStore, MutableDisposable } from "@mas/base/common/lifecycle";
import { isAbsolute } from "@mas/base/common/path";
import { isLinux } from "@mas/base/common/platform";
import { URI } from "@mas/base/common/uri";
import { FileChangeType, IFileChange, isParent } from "@mas/core/platform/files/common/files";
    ...
    processEvent(event: IFileChange): void {
        ...
        if (existingEvent) {
            ...
            if (
                ...
                (event.type === FileChangeType.DELETED || event.type === FileChangeType.ADDED)
            ) {
                keepEvent = true;
            }
