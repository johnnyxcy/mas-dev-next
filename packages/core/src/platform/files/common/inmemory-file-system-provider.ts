/*
 * File: @mas/core/src/platform/files/common/inmemory-file-system-provider.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 11/02/2023 03:05 pm
 *
 * Last Modified: 11/02/2023 03:06 pm
 *
...
import * as resources from "@mas/base/common/resources";
        ...
        IFileSystemProviderWithFileAtomicDeleteCapability
{
    ...
    read(fd: number, pos: number, data: Uint8Array, offset: number, length: number): Promise<number> {
        ...
        const toWrite = BinaryBuffer.wrap(memory).slice(pos, pos + length);
    ...
    write(fd: number, pos: number, data: Uint8Array, offset: number, length: number): Promise<number> {
        ...
        const toWrite = BinaryBuffer.wrap(data).slice(offset, offset + length);
