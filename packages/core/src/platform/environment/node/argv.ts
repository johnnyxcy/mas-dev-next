/*
 * File: @mas/core/src/platform/environment/node/argv.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 11/07/2023 05:26 pm
 *
 * Last Modified: 11/22/2023 04:41 pm
 *
...
const helpCategories = {
    o: nls.localizeByDefault("Options"),
    e: nls.localizeByDefault("Extensions Management"),
    t: nls.localizeByDefault("Troubleshooting"),
};
...
export const OPTIONS: OptionDescriptions<Required<NativeParsedArgs>> = {
    "tunnel": {
        ...
        options: {
            "cli-data-dir": {
                type: "string",
                args: "dir",
                description: nls.localizeByDefault("Directory where CLI metadata should be stored."),
            },
    ...
    "diff": {
        ...
        alias: "d",
        args: ["file", "file"],
        description: nls.localizeByDefault("Compare two files with each other."),
    },
    "merge": {
        type: "boolean",
        cat: "o",
    ...
    "add": {
        ...
        alias: "a",
        args: "folder",
        description: nls.localizeByDefault("Add folder(s) to the last active window."),
    },
    "goto": {
        type: "boolean",
        cat: "o",
        ...
        description: nls.localizeByDefault("Open a file at the path on the specified line and character position."),
    },
    "new-window": {
        type: "boolean",
        cat: "o",
        alias: "n",
        description: nls.localizeByDefault("Force to open a new window."),
    },
    "reuse-window": {
        type: "boolean",
        cat: "o",
        alias: "r",
        description: nls.localizeByDefault("Force to open a file or folder in an already opened window."),
    },
    "wait": {
        type: "boolean",
        cat: "o",
        alias: "w",
        description: nls.localizeByDefault("Wait for the files to be closed before returning."),
    },
    ...
    "locale": {
        ...
        cat: "o",
        args: "locale",
        description: nls.localizeByDefault("The locale to use (e.g. en-US or zh-TW)."),
    },
    "user-data-dir": {
        type: "string",
        cat: "o",
    ...
    "help": { type: "boolean", cat: "o", alias: "h", description: nls.localizeByDefault("Print usage.") },
    ...
    "extensions-dir": {
        ...
        cat: "e",
        args: "dir",
        description: nls.localizeByDefault("Set the root path for extensions."),
    },
    ...
    "list-extensions": {
        type: "boolean",
        cat: "e",
        description: nls.localizeByDefault("List the installed extensions."),
    },
    "show-versions": {
        type: "boolean",
        cat: "e",
        description: nls.localizeByDefault("Show versions of installed extensions, when using --list-extensions."),
    },
    "category": {
        type: "string",
    ...
    "uninstall-extension": {
        ...
        cat: "e",
        args: "ext-id",
        description: nls.localizeByDefault("Uninstalls an extension."),
    },
    "enable-proposed-api": {
        type: "string[]",
        allowEmptyValue: true,
    ...
    "version": { type: "boolean", cat: "t", alias: "v", description: nls.localizeByDefault("Print version.") },
    "verbose": {
        type: "boolean",
        cat: "t",
        global: true,
        description: nls.localizeByDefault("Print verbose output (implies --wait)."),
    },
    "log": {
        type: "string[]",
        cat: "t",
    ...
    "status": {
        ...
        alias: "s",
        cat: "t",
        description: nls.localizeByDefault("Print process usage and diagnostics information."),
    },
    "prof-startup": {
        type: "boolean",
        cat: "t",
        description: nls.localizeByDefault("Run CPU profiler during startup."),
    },
    ...
    "sync": {
        type: "string",
        cat: "t",
        description: nls.localizeByDefault("Turn sync on or off."),
        args: ["on | off"],
    },
    ...
    "disable-gpu": {
        type: "boolean",
        cat: "t",
        description: nls.localizeByDefault("Disable GPU hardware acceleration."),
    },
    ...
    "telemetry": {
        type: "boolean",
        cat: "t",
        description: nls.localizeByDefault("Shows all telemetry events which VS code collects."),
    },
...
export function parseArgs<T>(
    ...
    cleanedArgs._ = parsedArgs._.map(String).filter((arg) => arg.length > 0);
                    ...
                    if (!val) {
                        ...
                        if (val) {
                            errorReporter.onDeprecatedOption(
                                deprecatedId,
                                o.deprecationMessage || nls.localizeByDefault("Use {0} instead.", optionId),
                            );
                        }
                    }
...
export function buildHelpMessage(
    ...
    const inputFiles = capabilities?.noInputFiles !== true ? `[${nls.localizeByDefault("paths")}...]` : "";

    const help = [`${productName} ${version}`];
    help.push("");
    help.push(
        `${nls.localizeByDefault("Usage")}: ${executableName} [${nls.localizeByDefault("options")}]${inputFiles}`,
    );
    help.push("");
    ...
    if (subcommands.length) {
        help.push(nls.localizeByDefault("Subcommands"));
        help.push(
            ...formatUsageTexts(
...
export function buildVersionMessage(version: string | undefined, commit: string | undefined): string {
    return `${version || nls.localizeByDefault("Unknown version")}\n${
        commit || nls.localizeByDefault("Unknown commit")
    }\n${process.arch}`;
}
