/*
 * File: @mas/core/src/platform/environment/common/native-environment-service.ts
 *
 * Author: Johnny Xu <johnny.xcy1997@outlook.com>
 *
 * File Created: 11/09/2023 09:44 am
 *
 * Last Modified: 11/22/2023 04:42 pm
 *
...
import { toLocalISOString } from "@mas/base/common/date";
import { memoize } from "@mas/base/common/decorators";
import { Schemas } from "@mas/base/common/network";
import { join, normalize, resolve } from "@mas/base/common/path";
import { env } from "@mas/base/common/process";
...
import { ExtensionKind, IExtensionHostDebugParams } from "@mas/core/platform/environment/common/environment";
...
export abstract class AbstractNativeEnvironmentService implements INativeEnvironmentService {
    ...
    @memoize
    get appRoot(): string {
        return FileAccess.asFileUri("").fsPath;
    }
